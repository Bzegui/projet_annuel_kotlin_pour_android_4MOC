...
interface RecipeApi {
    ...
    @GET("users/{idFirebase}/likes")
    suspend fun getLikedRecipe(@Path("idFirebase") idFirebase: String): List<RecipeDto>?
    ...
    @PUT("users/{idFirebase}/likes/{recipeId}")
    suspend fun addLikeUser(
